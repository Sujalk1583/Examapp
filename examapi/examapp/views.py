...
from examapp.models import Admin, Question, Result, Users
from examapp.serializers import QuestionSerializer, ResultSerializers, UsersSerializers
...
def getAllQuestions(request,subject):
    ...
    serilizer=QuestionSerializer(allquestions,many=True)
...
def saveUser(request):
    ...
    serilizer=UsersSerializers(data=request.data)
...
def saveResult(request):
    ...
    serilizer=ResultSerializers(data=request.data)
...
def getResults(request,subject):
    ...
    serilizer=ResultSerializers(allresults,many=True)
    return Response(serilizer.data)
...
def viewQuestion(request,qno,subject):
    ...
    serilizer=QuestionSerializer(questionfromdb) 
...
def addQuestion(request):
    ...
    serilizer=QuestionSerializer(data=request.data)
...
def updateQuestion(request):
    ...
    serilizer=QuestionSerializer(questionfromdb,data=questionFromClient,partial=False)
    if serilizer.is_valid():
        serilizer.save()
    return Response(True)    
